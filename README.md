...
**Basic Run:**
```bash
node evm64-cli.mjs run <bytecode_hex>
```

**Run with Trace:**
```bash
node evm64-cli.mjs run --trace <bytecode_hex>
```

Example:
```bash
# Runs PUSH1 0x02, PUSH1 0x03, ADD (2 + 3 = 5)
node evm64-cli.mjs run --trace 6002600301
```
...
**Compile Assembly:**
```bash
node compiler-cli.mjs compile <file.asm>
```

**Disassemble Bytecode:**
```bash
node compiler-cli.mjs disassemble <bytecode_hex>
```

### 3. Web Interface

Open `index.html` in your browser to access the graphical interface. It allows you to:
*   Input bytecode.
*   Run execution.
